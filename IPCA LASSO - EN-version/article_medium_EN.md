...
The final matrix has **{{N_PREDICTORS}} candidate predictors**: 12 lags of each of the five predictive blocks — including the IPCA itself — plus 11 monthly dummies. The Focus median enters separately, via the Olinda Market Expectations API, as a real-time benchmark.
